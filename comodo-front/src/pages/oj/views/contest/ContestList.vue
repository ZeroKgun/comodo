<template>
  <div>
    ...
    <div class="contest-list-container">
      ...
      <neon-box color="#B93234" class="my-3" v-for="(contest, index) in contestsUnderway" :key="'unp' + index"
      ...
      <neon-box color="#B93234" class="my-3" v-for="(contest, index) in contestsUpcoming" :key="'upp' + index"
        ...
        <template #overlay-icon>
          <b-icon-zoom-in color="#B93234" width="1.5em" height="1.5em"></b-icon-zoom-in>
        </template>
      </neon-box>
